...
class TestListeningReadingButton(unittest.TestCase):
    ...
    def switch_reading(self):
        ...
        self.Assertion_reading_screen = self.driver.find_element(by=AppiumBy.XPATH,
                                                                 value="/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View/android.view.View[3]/android.widget.Button[2]")
        assert self.Assertion_reading_screen.is_displayed(), "The screen did not display after clicking the button."

        # self.close_reading_Screen = self.driver.find_element(by=AppiumBy.XPATH,
        #                                                      value="/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View/android.view.View[3]/android.widget.Button[1]")
        # self.close_reading_Screen.click()
        # print("reading screen is closed")
    ...
    def reading_button(self):

        self.test_reading_button = self.driver.find_element(AppiumBy.ANDROID_UIAUTOMATOR,
                                                            value='new UiSelector().resourceId("ReadingButton")')
        self.test_reading_button.click()

    def test_run(self):
        TestListeningReadingButton.check_freemium_user(self)
        TestListeningReadingButton.click_on_listening(self)
        TestListeningReadingButton.switch_reading(self)
        TestListeningReadingButton.download(self)
